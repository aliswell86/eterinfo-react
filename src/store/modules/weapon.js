...
export default handleActions({
  ...
  [GET_WEAPON_WHERE_LIST]: (state, action) => {
    const {
      clyn, illegal,
      isType1, isType2, isType3, isType4, isType5, isType6, isType7, isType8, isType9,
      isType10, isType11, isType12, isType13, isType14,
    ...
    const weapons = state.toJS().weapons.filter(weapon => 
      (
        ...
        weapon.item_dtl_dv === (isType8 ? '기관단총' : '') ||
        weapon.item_dtl_dv === (isType9 ? '특수화기' : '') ||
        weapon.item_dtl_dv === (isType10 ? '도검' : '') ||
        weapon.item_dtl_dv === (isType11 ? '둔기' : '') ||
        weapon.item_dtl_dv === (isType12 ? '도끼' : '') ||
        weapon.item_dtl_dv === (isType13 ? '장창' : '') ||
        weapon.item_dtl_dv === (isType14 ? '미늘창' : '')
      ) && (
